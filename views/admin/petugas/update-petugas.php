...
$petugas = $TablePetugas->findPetugas($_GET["id"]);
// authentication
...
if(isset($_POST["update"])) {
    // var_dump($_POST);
    $result = $TablePetugas->updatePetugas($_POST, $_GET["id"]);
    if( $result > 0) {
        $success = true;
    } else {
        $error = true;
        ...
        <div class="w-full mx-auto bg-slate-300 rounded-lg overflow-hidden">
            ...
            <div class="w-full px-4 py-5 bg-slate-300 sm:p-6 col-span-2">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input autocomplete="off" type="text" id="nama" name="nama" placeholder="Masukkan nama Anda" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" value="<?= $petugas["nama"] ?>">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input autocomplete="off" type="email" id="email" name="email" placeholder="Masukkan email Anda" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" value="<?= $petugas["email"] ?>">
                ...
                <input type="hidden" name="foto_lama" value="<?= $petugas["foto_profile"] ?>">
                <div class="flex flex-col gap-2">
                ...
                <div class="">
                    <button type="submit" name="update" class="bg-gray-700 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded">Submit</button>
                </div>
                </form>
            </div>
