...
if(isset($_POST["update"])) {
    $create = $TableKompetensi->updateKompetensi($_POST, $_GET["id"]);
    if($create > 0) {
        $succ = true;
    } else {
        $err = true;
...
<?php if($succ) : ?>
    <div class="w-full h-screen overflow-hidden flex justify-center items-center fixed bg-slate-200 bg-opacity-60 backdrop-blur-md z-50" id="myModal">
        ...
        <div class="w-full flex items-center justify-center min-h-screen p-4">
            ...
            <div class="mb-4">
                <p>Kompetensi Keahlian berhasil diupdate</p>
            </div>
    ...
    <?php elseif($err) : ?>
        ...
        <div class="w-full flex items-center justify-center min-h-screen p-4">
            ...
            <div class="mb-4">
                <p>Kompetensi Keahlian gagal diupdate</p>
            </div>
            <div class="text-right">
    ...
    <div class="flex flex-col justify-center items-center w-full h-full">
        <p class="text-2xl font-bold">Update Kompetensi</p>
