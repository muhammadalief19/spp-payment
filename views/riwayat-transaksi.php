...
<nav class="bg-transparent backdrop-blur-xl shadow-lg h-16 fixed top-0 left-0 right-0 z-10" id="navbar">
  ...
  <div class="sm:hidden" id="mobile-menu">
    ...
    <section class="w-full h-screen py-20 flex justify-center items-center text-gray-800">
        <div class="w-3/4 flex justify-center">
            <div class="flex overflow-x-hidden rounded-lg shadow-2xl shadow-gray-600 bg-white">
                <img src="../public/assets/bukti-pembayaran/<?= $siswa["bukti_pembayaran"] ?>" alt="" class="w-1/4">
                <div class="flex flex-1 flex-col p-6 gap-5">
                    <p class="text-3xl font-bold text-center">Riwayat Transaksi</p>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <span class="px-8 py-1 w-max font-bold uppercase rounded-3xl <?= ($siswa["status"] === "disetujui") ? "bg-green-400 text-green-600" : ( ($siswa["status"] === "pending") ? "bg-yellow-400 text-yellow-600" : (($siswa["status"] === "ditolak") ? "bg-red-400 text-red-600" :  "") )?>">
                            <?= $siswa["status"] ?>
                        </span>
                    </div>
                </div>
